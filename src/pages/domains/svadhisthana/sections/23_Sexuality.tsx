...
export const SexualitySection: React.FC = () => {
  ...
  return (
    <section className="h-screen w-full flex items-center justify-center px-6 relative overflow-hidden bg-[#050010]">
      ...
      <div className="max-w-5xl mx-auto w-full relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <div className="space-y-8 text-lg leading-relaxed text-orange-100/70 font-sans font-light">
            <motion.p initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
              In modern psychology and New Age systems, SvÄdhiá¹£á¹­hÄna is heavily associated with human sexuality and reproductive energy.
            </motion.p>
            ...
            <motion.p initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.4 }} viewport={{ once: true }}>
              Sexuality is one profound manifestation of the "sacral" energyâ€”the drive to connect, to feel deeply, and to create. However, reducing the entire chakra exclusively to sex ignores its broader domains of general emotion, adaptability, and artistic creation.
            </motion.p>
