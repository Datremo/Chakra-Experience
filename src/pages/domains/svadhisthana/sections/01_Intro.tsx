...
export const IntroSection: React.FC = () => {
  ...
  return (
    <section className="h-screen w-full relative flex flex-col items-center justify-center overflow-hidden pt-20 px-6">
      ...
      <AnimatePresence>
        {(phase === 'REVEAL' || phase === 'QUESTION') && (
          <motion.div 
            ...
            className={`text-center transition-all duration-1000 w-full px-4 ${phase === 'QUESTION' ? 'scale-75 -translate-y-32' : 'scale-100 translate-y-0'}`}
          >
            <h1 className="text-6xl sm:text-[8rem] md:text-[10rem] font-serif leading-none text-orange-500/20 mb-[-3rem] sm:mb-[-6rem] md:mb-[-8rem]">
