...
export const ReturnToJourneySection: React.FC<Props> = ({ onClose }) => {
  ...
  return <section className="relative min-h-screen overflow-hidden bg-amber-900/10 backdrop-blur-md border border-amber-500/20 shadow-[0_0_30px_rgba(245,158,11,0.05)] text-white flex items-center justify-center px-6">
    ...
    <div className="relative z-10 max-w-3xl text-center">
      ...
      <motion.div initial={{opacity:0}} animate={{opacity:ready?1:0}} transition={{duration:1}} className="mt-12">
        <button onClick={onClose} className="inline-flex items-center gap-4 px-7 py-4 rounded-full border border-amber-200/25 bg-amber-900/10 backdrop-blur-md border border-amber-500/20 shadow-[0_0_30px_rgba(245,158,11,0.05)] hover:bg-amber-100/5 hover:border-amber-200/45 transition-all text-xs tracking-[.25em] uppercase text-amber-50">
