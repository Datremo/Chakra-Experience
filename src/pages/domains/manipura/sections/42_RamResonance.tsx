...
export const RamResonanceSection: React.FC = () => {
  ...
  return <WorldFrame eyebrow="27 — BĪJA" title="Let Rāṃ become a focal point." copy="A contemplative resonance chamber. Press and hold to animate the visual field around the traditional bīja. No activation score—just a place to attend." scene="temple">
    <div className="max-w-4xl mx-auto rounded-[2rem] border border-amber-100/10 bg-amber-900/10 backdrop-blur-md border border-amber-500/20 shadow-[0_0_30px_rgba(245,158,11,0.05)] min-h-[480px] flex items-center justify-center relative overflow-hidden">
      ...
      <button onPointerDown={()=>setActive(true)} onPointerUp={()=>setActive(false)} onPointerCancel={()=>setActive(false)} onPointerLeave={()=>setActive(false)} className="relative z-10 w-48 h-48 rounded-full border border-amber-300/20 bg-amber-900/10 backdrop-blur-md border border-amber-500/20 shadow-[0_0_30px_rgba(245,158,11,0.05)] flex flex-col items-center justify-center select-none touch-none">
