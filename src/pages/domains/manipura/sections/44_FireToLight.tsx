...
export const FireToLightSection: React.FC = () => <WorldFrame eyebrow="29 — INTEGRATION" title="The fire no longer needs to prove itself." copy="Its job is complete. What began as heat becomes clarity: directed, steady, useful light." scene="sun">
  <div className="relative max-w-5xl mx-auto min-h-[460px] rounded-[2rem] overflow-hidden border border-amber-100/10 bg-amber-900/10 backdrop-blur-md border border-amber-500/20 shadow-[0_0_30px_rgba(245,158,11,0.05)] flex items-center justify-center">
